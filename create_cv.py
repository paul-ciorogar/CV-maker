...
doc = SimpleDocTemplate(
    "/home/paul/Documents/Paul_Ciorogar_CV_2026.pdf",
    pagesize=letter,
...
story.append(Paragraph(
    "October 2022 - December 2024 | Sibiu, Romania (Remote)", job_details_style))
story.append(Paragraph(
...
# Build PDF
doc.build(story)
print("PDF created successfully: Paul_Ciorogar_CV_2026.pdf")
